...
namespace Tests.Runtime
{
    public class UtilTests
    {
        ...
        (string[] concatenations, string initials) GetConcatenations(string[] words)
        {
            ...
            ret.Add(string.Join("",
                words.Select(e => e.Length > 0 ? e.Substring(0, 1).ToUpper() + e.Substring(1) : e)));
        ...
        public void StringUtility_GetInitials_PseudoRandom([Range(0, 100, 1)] int seed)
        {
            ...
            var words = Enumerable.Range(0, wordCount).Select(_i => randomWords[Random.Range(0, randomWords.Length)])
                .ToArray();
